/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     6/29/2012 2:41:18 PM                         */
/*==============================================================*/
...
(
   ...
   BERKAS_IJAZAH        varchar(30),
   GELAR                varchar(5),
   primary key (ID_TINGKAT, ID_PT, ID_PS, ID_PEL)
)type = InnoDB;
...
alter table PENDIDIKANFORMALPT add constraint FK_PENDIDIKANFORMALPTPELAMAR foreign key (ID_PEL)
      references PELAMAR (ID_PEL) on delete cascade on update cascade;

alter table PENDIDIKANFORMALPT add constraint FK_PERGURUANTINGGIPENDIDIKANFORMALPT foreign key (ID_PT)
      references PERGURUANTINGGI (ID_PT) on delete cascade on update cascade;

alter table PENDIDIKANFORMALPT add constraint FK_PROGRAMSTUDIPENDIDIKANFORMALPT foreign key (ID_PS)
      references PROGRAMSTUDI (ID_PS) on delete cascade on update cascade;

alter table PENDIDIKANFORMALPT add constraint FK_TINGKATPENDIDIKANPENDIDIKANFORMALPT foreign key (ID_TINGKAT)
      references TINGKATPENDIDIKAN (ID_TINGKAT) on delete cascade on update cascade;
...
alter table PESERTA add constraint FK_PESERTABIDANGDIBUKA foreign key (ID_REKRUTMEN, ID_BID)
