...
<!-- JavaScripts-->
<script type="text/javascript" src="<? echo base_url();?>assets/transdmin/style/js/jquery.js"></script>
<script type="text/javascript" src="<? echo base_url();?>assets/transdmin/style/js/jNice.js"></script>
</head>
