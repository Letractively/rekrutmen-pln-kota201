...
<table width="606" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td><input type="text" name="nama" id="nama" value="<?php echo set_value('nama',(isset($form['nama'])) ? $form['nama'] : '');?>"/>
    *</td>
    <td><?php echo form_error('nama'); ?></td>
  </tr>
  <tr>
    <td>Tempat/Alamat</td>
    <td><textarea name="tempat" id="tempat"><?php echo set_value('tempat',(isset($form['tempat'])) ? $form['tempat'] : '');?></textarea>
    *</td>
