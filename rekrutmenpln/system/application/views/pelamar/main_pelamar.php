...
<body>
<?php echo anchor('akunPelamar', 'Registrasi')?> | <?php echo anchor('login', 'Login') ?>| <?php echo anchor('pelamar', 'IsiData')?>| <?php echo anchor('Login/logout', 'Logout')?>| <?php echo anchor('pelamar/addKursus', 'Add Kursus')?>
